...
nouveauaudio1.setAttribute("id", "1wav");
nouveauaudio1.setAttribute("autobuffer", " ");
 nouveauaudio1a = document.createElement("source");
  nouveauaudio1a.setAttribute("src", "data:audio/wav;base1wave2,");
...
anouveauaudio1.setAttribute("id", "1awav");
anouveauaudio1.setAttribute("autobuffer", " ");
 anouveauaudio1a = document.createElement("source");
  anouveauaudio1a.setAttribute("src", "data:audio/wav;abase1wave2,");
...
bnouveauaudio1.setAttribute("id", "1bwav");
bnouveauaudio1.setAttribute("autobuffer", " ");
 bnouveauaudio1a = document.createElement("source");
  bnouveauaudio1a.setAttribute("src", "data:audio/wav;bbase1wave2,");
...
cnouveauaudio1.setAttribute("id", "1cwav");
cnouveauaudio1.setAttribute("autobuffer", " ");
 cnouveauaudio1a = document.createElement("source");
  cnouveauaudio1a.setAttribute("src", "data:audio/wav;cbase1wave2,");
...
var audio = document.getElementById("1wav");
var source = document.createElement("source");
source.setAttribute("src", lenommeur);
audio.appendChild(source);

alenommeur = wave1.generate1();
var aaudio = document.getElementById("1awav");
...
var baudio = document.getElementById("1bwav");
...
var caudio = document.getElementById("1cwav");
