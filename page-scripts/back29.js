...
nouveauaudio1.setAttribute("id", "19wav");
nouveauaudio1.setAttribute("autobuffer", " ");
 nouveauaudio1a = document.createElement("source");
  nouveauaudio1a.setAttribute("src", "data:audio/wav;base19wave2,");
...
anouveauaudio1.setAttribute("id", "19awav");
anouveauaudio1.setAttribute("autobuffer", " ");
 anouveauaudio1a = document.createElement("source");
  anouveauaudio1a.setAttribute("src", "data:audio/wav;abase19wave2,");
...
bnouveauaudio1.setAttribute("id", "19bwav");
bnouveauaudio1.setAttribute("autobuffer", " ");
 bnouveauaudio1a = document.createElement("source");
  bnouveauaudio1a.setAttribute("src", "data:audio/wav;bbase19wave2,");
...
cnouveauaudio1.setAttribute("id", "19cwav");
cnouveauaudio1.setAttribute("autobuffer", " ");
 cnouveauaudio1a = document.createElement("source");
  cnouveauaudio1a.setAttribute("src", "data:audio/wav;cbase19wave2,");
...
var audio = document.getElementById("19wav");
var source = document.createElement("source");
source.setAttribute("src", lenommeur);
audio.appendChild(source);

alenommeur = wave1.generate1();
var aaudio = document.getElementById("19awav");
...
var baudio = document.getElementById("19bwav");
...
var caudio = document.getElementById("19cwav");
