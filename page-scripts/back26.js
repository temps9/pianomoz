...
nouveauaudio1.setAttribute("id", "11wav");
nouveauaudio1.setAttribute("autobuffer", " ");
 nouveauaudio1a = document.createElement("source");
  nouveauaudio1a.setAttribute("src", "data:audio/wav;base11wave2,");
...
anouveauaudio1.setAttribute("id", "11awav");
anouveauaudio1.setAttribute("autobuffer", " ");
 anouveauaudio1a = document.createElement("source");
  anouveauaudio1a.setAttribute("src", "data:audio/wav;abase11wave2,");
...
bnouveauaudio1.setAttribute("id", "11bwav");
bnouveauaudio1.setAttribute("autobuffer", " ");
 bnouveauaudio1a = document.createElement("source");
  bnouveauaudio1a.setAttribute("src", "data:audio/wav;bbase11wave2,");
...
cnouveauaudio1.setAttribute("id", "11cwav");
cnouveauaudio1.setAttribute("autobuffer", " ");
 cnouveauaudio1a = document.createElement("source");
  cnouveauaudio1a.setAttribute("src", "data:audio/wav;cbase11wave2,");
...
var audio = document.getElementById("11wav");
var source = document.createElement("source");
source.setAttribute("src", lenommeur);
audio.appendChild(source);

alenommeur = wave1.generate1();
var aaudio = document.getElementById("11awav");
...
var baudio = document.getElementById("11bwav");
...
var caudio = document.getElementById("11cwav");
