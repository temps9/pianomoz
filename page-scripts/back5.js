...
nouveauaudio1.setAttribute("id", "8wav");
nouveauaudio1.setAttribute("autobuffer", " ");
 nouveauaudio1a = document.createElement("source");
  nouveauaudio1a.setAttribute("src", "data:audio/wav;base8wave2,");
...
anouveauaudio1.setAttribute("id", "8awav");
anouveauaudio1.setAttribute("autobuffer", " ");
 anouveauaudio1a = document.createElement("source");
  anouveauaudio1a.setAttribute("src", "data:audio/wav;abase8wave2,");
...
bnouveauaudio1.setAttribute("id", "8bwav");
bnouveauaudio1.setAttribute("autobuffer", " ");
 bnouveauaudio1a = document.createElement("source");
  bnouveauaudio1a.setAttribute("src", "data:audio/wav;bbase8wave2,");
...
cnouveauaudio1.setAttribute("id", "8cwav");
cnouveauaudio1.setAttribute("autobuffer", " ");
 cnouveauaudio1a = document.createElement("source");
  cnouveauaudio1a.setAttribute("src", "data:audio/wav;cbase8wave2,");
...
var audio = document.getElementById("8wav");
var source = document.createElement("source");
source.setAttribute("src", lenommeur);
audio.appendChild(source);

alenommeur = wave1.generate1();
var aaudio = document.getElementById("8awav");
...
var baudio = document.getElementById("8bwav");
...
var caudio = document.getElementById("8cwav");
