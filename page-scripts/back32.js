...
nouveauaudio1.setAttribute("id", "26wav");
nouveauaudio1.setAttribute("autobuffer", " ");
 nouveauaudio1a = document.createElement("source");
  nouveauaudio1a.setAttribute("src", "data:audio/wav;base26wave2,");
...
anouveauaudio1.setAttribute("id", "26awav");
anouveauaudio1.setAttribute("autobuffer", " ");
 anouveauaudio1a = document.createElement("source");
  anouveauaudio1a.setAttribute("src", "data:audio/wav;abase26wave2,");
...
bnouveauaudio1.setAttribute("id", "26bwav");
bnouveauaudio1.setAttribute("autobuffer", " ");
 bnouveauaudio1a = document.createElement("source");
  bnouveauaudio1a.setAttribute("src", "data:audio/wav;bbase26wave2,");
...
cnouveauaudio1.setAttribute("id", "26cwav");
cnouveauaudio1.setAttribute("autobuffer", " ");
 cnouveauaudio1a = document.createElement("source");
  cnouveauaudio1a.setAttribute("src", "data:audio/wav;cbase26wave2,");
...
var audio = document.getElementById("26wav");
var source = document.createElement("source");
source.setAttribute("src", lenommeur);
audio.appendChild(source);

alenommeur = wave1.generate1();
var aaudio = document.getElementById("26awav");
...
var baudio = document.getElementById("26bwav");
...
var caudio = document.getElementById("26cwav");
