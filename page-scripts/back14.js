...
nouveauaudio1.setAttribute("id", "24wav");
nouveauaudio1.setAttribute("autobuffer", " ");
 nouveauaudio1a = document.createElement("source");
  nouveauaudio1a.setAttribute("src", "data:audio/wav;base24wave2,");
...
anouveauaudio1.setAttribute("id", "24awav");
anouveauaudio1.setAttribute("autobuffer", " ");
 anouveauaudio1a = document.createElement("source");
  anouveauaudio1a.setAttribute("src", "data:audio/wav;abase24wave2,");
...
bnouveauaudio1.setAttribute("id", "24bwav");
bnouveauaudio1.setAttribute("autobuffer", " ");
 bnouveauaudio1a = document.createElement("source");
  bnouveauaudio1a.setAttribute("src", "data:audio/wav;bbase24wave2,");
...
cnouveauaudio1.setAttribute("id", "24cwav");
cnouveauaudio1.setAttribute("autobuffer", " ");
 cnouveauaudio1a = document.createElement("source");
  cnouveauaudio1a.setAttribute("src", "data:audio/wav;cbase24wave2,");
...
var audio = document.getElementById("24wav");
var source = document.createElement("source");
source.setAttribute("src", lenommeur);
audio.appendChild(source);

alenommeur = wave1.generate1();
var aaudio = document.getElementById("24awav");
...
var baudio = document.getElementById("24bwav");
...
var caudio = document.getElementById("24cwav");
