...
nouveauaudio1.setAttribute("id", "35wav");
nouveauaudio1.setAttribute("autobuffer", " ");
 nouveauaudio1a = document.createElement("source");
  nouveauaudio1a.setAttribute("src", "data:audio/wav;base35wave2,");
...
anouveauaudio1.setAttribute("id", "35awav");
anouveauaudio1.setAttribute("autobuffer", " ");
 anouveauaudio1a = document.createElement("source");
  anouveauaudio1a.setAttribute("src", "data:audio/wav;abase35wave2,");
...
bnouveauaudio1.setAttribute("id", "35bwav");
bnouveauaudio1.setAttribute("autobuffer", " ");
 bnouveauaudio1a = document.createElement("source");
  bnouveauaudio1a.setAttribute("src", "data:audio/wav;bbase35wave2,");
...
cnouveauaudio1.setAttribute("id", "35cwav");
cnouveauaudio1.setAttribute("autobuffer", " ");
 cnouveauaudio1a = document.createElement("source");
  cnouveauaudio1a.setAttribute("src", "data:audio/wav;cbase35wave2,");
...
var audio = document.getElementById("35wav");
var source = document.createElement("source");
source.setAttribute("src", lenommeur);
audio.appendChild(source);

alenommeur = wave1.generate1();
var aaudio = document.getElementById("35awav");
...
var baudio = document.getElementById("35bwav");
...
var caudio = document.getElementById("35cwav");
