...
nouveauaudio1.setAttribute("id", "14wav");
nouveauaudio1.setAttribute("autobuffer", " ");
 nouveauaudio1a = document.createElement("source");
  nouveauaudio1a.setAttribute("src", "data:audio/wav;base14wave2,");
...
anouveauaudio1.setAttribute("id", "14awav");
anouveauaudio1.setAttribute("autobuffer", " ");
 anouveauaudio1a = document.createElement("source");
  anouveauaudio1a.setAttribute("src", "data:audio/wav;abase14wave2,");
...
bnouveauaudio1.setAttribute("id", "14bwav");
bnouveauaudio1.setAttribute("autobuffer", " ");
 bnouveauaudio1a = document.createElement("source");
  bnouveauaudio1a.setAttribute("src", "data:audio/wav;bbase14wave2,");
...
cnouveauaudio1.setAttribute("id", "14cwav");
cnouveauaudio1.setAttribute("autobuffer", " ");
 cnouveauaudio1a = document.createElement("source");
  cnouveauaudio1a.setAttribute("src", "data:audio/wav;cbase14wave2,");
...
var audio = document.getElementById("14wav");
var source = document.createElement("source");
source.setAttribute("src", lenommeur);
audio.appendChild(source);

alenommeur = wave1.generate1();
var aaudio = document.getElementById("14awav");
...
var baudio = document.getElementById("14bwav");
...
var caudio = document.getElementById("14cwav");
