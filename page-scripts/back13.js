...
nouveauaudio1.setAttribute("id", "22wav");
nouveauaudio1.setAttribute("autobuffer", " ");
 nouveauaudio1a = document.createElement("source");
  nouveauaudio1a.setAttribute("src", "data:audio/wav;base22wave2,");
...
anouveauaudio1.setAttribute("id", "22awav");
anouveauaudio1.setAttribute("autobuffer", " ");
 anouveauaudio1a = document.createElement("source");
  anouveauaudio1a.setAttribute("src", "data:audio/wav;abase22wave2,");
...
bnouveauaudio1.setAttribute("id", "22bwav");
bnouveauaudio1.setAttribute("autobuffer", " ");
 bnouveauaudio1a = document.createElement("source");
  bnouveauaudio1a.setAttribute("src", "data:audio/wav;bbase22wave2,");
...
cnouveauaudio1.setAttribute("id", "22cwav");
cnouveauaudio1.setAttribute("autobuffer", " ");
 cnouveauaudio1a = document.createElement("source");
  cnouveauaudio1a.setAttribute("src", "data:audio/wav;cbase22wave2,");
...
var audio = document.getElementById("22wav");
var source = document.createElement("source");
source.setAttribute("src", lenommeur);
audio.appendChild(source);

alenommeur = wave1.generate1();
var aaudio = document.getElementById("22awav");
...
var baudio = document.getElementById("22bwav");
...
var caudio = document.getElementById("22cwav");
