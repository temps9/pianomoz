...
nouveauaudio1.setAttribute("id", "17wav");
nouveauaudio1.setAttribute("autobuffer", " ");
 nouveauaudio1a = document.createElement("source");
  nouveauaudio1a.setAttribute("src", "data:audio/wav;base17wave2,");
...
anouveauaudio1.setAttribute("id", "17awav");
anouveauaudio1.setAttribute("autobuffer", " ");
 anouveauaudio1a = document.createElement("source");
  anouveauaudio1a.setAttribute("src", "data:audio/wav;abase17wave2,");
...
bnouveauaudio1.setAttribute("id", "17bwav");
bnouveauaudio1.setAttribute("autobuffer", " ");
 bnouveauaudio1a = document.createElement("source");
  bnouveauaudio1a.setAttribute("src", "data:audio/wav;bbase17wave2,");
...
cnouveauaudio1.setAttribute("id", "17cwav");
cnouveauaudio1.setAttribute("autobuffer", " ");
 cnouveauaudio1a = document.createElement("source");
  cnouveauaudio1a.setAttribute("src", "data:audio/wav;cbase17wave2,");
...
var audio = document.getElementById("17wav");
var source = document.createElement("source");
source.setAttribute("src", lenommeur);
audio.appendChild(source);

alenommeur = wave1.generate1();
var aaudio = document.getElementById("17awav");
...
var baudio = document.getElementById("17bwav");
...
var caudio = document.getElementById("17cwav");
