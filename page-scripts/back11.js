...
nouveauaudio1.setAttribute("id", "18wav");
nouveauaudio1.setAttribute("autobuffer", " ");
 nouveauaudio1a = document.createElement("source");
  nouveauaudio1a.setAttribute("src", "data:audio/wav;base18wave2,");
...
anouveauaudio1.setAttribute("id", "18awav");
anouveauaudio1.setAttribute("autobuffer", " ");
 anouveauaudio1a = document.createElement("source");
  anouveauaudio1a.setAttribute("src", "data:audio/wav;abase18wave2,");
...
bnouveauaudio1.setAttribute("id", "18bwav");
bnouveauaudio1.setAttribute("autobuffer", " ");
 bnouveauaudio1a = document.createElement("source");
  bnouveauaudio1a.setAttribute("src", "data:audio/wav;bbase18wave2,");
...
cnouveauaudio1.setAttribute("id", "18cwav");
cnouveauaudio1.setAttribute("autobuffer", " ");
 cnouveauaudio1a = document.createElement("source");
  cnouveauaudio1a.setAttribute("src", "data:audio/wav;cbase18wave2,");
...
var audio = document.getElementById("18wav");
var source = document.createElement("source");
source.setAttribute("src", lenommeur);
audio.appendChild(source);

alenommeur = wave1.generate1();
var aaudio = document.getElementById("18awav");
...
var baudio = document.getElementById("18bwav");
...
var caudio = document.getElementById("18cwav");
