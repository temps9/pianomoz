...
nouveauaudio1.setAttribute("id", "3wav");
nouveauaudio1.setAttribute("autobuffer", " ");
 nouveauaudio1a = document.createElement("source");
  nouveauaudio1a.setAttribute("src", "data:audio/wav;base3wave2,");
...
anouveauaudio1.setAttribute("id", "3awav");
anouveauaudio1.setAttribute("autobuffer", " ");
 anouveauaudio1a = document.createElement("source");
  anouveauaudio1a.setAttribute("src", "data:audio/wav;abase3wave2,");
...
bnouveauaudio1.setAttribute("id", "3bwav");
bnouveauaudio1.setAttribute("autobuffer", " ");
 bnouveauaudio1a = document.createElement("source");
  bnouveauaudio1a.setAttribute("src", "data:audio/wav;bbase3wave2,");
...
cnouveauaudio1.setAttribute("id", "3cwav");
cnouveauaudio1.setAttribute("autobuffer", " ");
 cnouveauaudio1a = document.createElement("source");
  cnouveauaudio1a.setAttribute("src", "data:audio/wav;cbase3wave2,");
...
var audio = document.getElementById("3wav");
var source = document.createElement("source");
source.setAttribute("src", lenommeur);
audio.appendChild(source);

alenommeur = wave1.generate1();
var aaudio = document.getElementById("3awav");
...
var baudio = document.getElementById("3bwav");
...
var caudio = document.getElementById("3cwav");
