...
nouveauaudio1.setAttribute("id", "36wav");
nouveauaudio1.setAttribute("autobuffer", " ");
 nouveauaudio1a = document.createElement("source");
  nouveauaudio1a.setAttribute("src", "data:audio/wav;base36wave2,");
...
anouveauaudio1.setAttribute("id", "36awav");
anouveauaudio1.setAttribute("autobuffer", " ");
 anouveauaudio1a = document.createElement("source");
  anouveauaudio1a.setAttribute("src", "data:audio/wav;abase36wave2,");
...
bnouveauaudio1.setAttribute("id", "36bwav");
bnouveauaudio1.setAttribute("autobuffer", " ");
 bnouveauaudio1a = document.createElement("source");
  bnouveauaudio1a.setAttribute("src", "data:audio/wav;bbase36wave2,");
...
cnouveauaudio1.setAttribute("id", "36cwav");
cnouveauaudio1.setAttribute("autobuffer", " ");
 cnouveauaudio1a = document.createElement("source");
  cnouveauaudio1a.setAttribute("src", "data:audio/wav;cbase36wave2,");
...
var audio = document.getElementById("36wav");
var source = document.createElement("source");
source.setAttribute("src", lenommeur);
audio.appendChild(source);

alenommeur = wave1.generate1();
var aaudio = document.getElementById("36awav");
...
var baudio = document.getElementById("36bwav");
...
var caudio = document.getElementById("36cwav");
