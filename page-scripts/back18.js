...
nouveauaudio1.setAttribute("id", "30wav");
nouveauaudio1.setAttribute("autobuffer", " ");
 nouveauaudio1a = document.createElement("source");
  nouveauaudio1a.setAttribute("src", "data:audio/wav;base30wave2,");
...
anouveauaudio1.setAttribute("id", "30awav");
anouveauaudio1.setAttribute("autobuffer", " ");
 anouveauaudio1a = document.createElement("source");
  anouveauaudio1a.setAttribute("src", "data:audio/wav;abase30wave2,");
...
bnouveauaudio1.setAttribute("id", "30bwav");
bnouveauaudio1.setAttribute("autobuffer", " ");
 bnouveauaudio1a = document.createElement("source");
  bnouveauaudio1a.setAttribute("src", "data:audio/wav;bbase30wave2,");
...
cnouveauaudio1.setAttribute("id", "30cwav");
cnouveauaudio1.setAttribute("autobuffer", " ");
 cnouveauaudio1a = document.createElement("source");
  cnouveauaudio1a.setAttribute("src", "data:audio/wav;cbase30wave2,");
...
var audio = document.getElementById("30wav");
var source = document.createElement("source");
source.setAttribute("src", lenommeur);
audio.appendChild(source);

alenommeur = wave1.generate1();
var aaudio = document.getElementById("30awav");
...
var baudio = document.getElementById("30bwav");
...
var caudio = document.getElementById("30cwav");
