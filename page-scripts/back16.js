...
nouveauaudio1.setAttribute("id", "27wav");
nouveauaudio1.setAttribute("autobuffer", " ");
 nouveauaudio1a = document.createElement("source");
  nouveauaudio1a.setAttribute("src", "data:audio/wav;base27wave2,");
...
anouveauaudio1.setAttribute("id", "27awav");
anouveauaudio1.setAttribute("autobuffer", " ");
 anouveauaudio1a = document.createElement("source");
  anouveauaudio1a.setAttribute("src", "data:audio/wav;abase27wave2,");
...
bnouveauaudio1.setAttribute("id", "27bwav");
bnouveauaudio1.setAttribute("autobuffer", " ");
 bnouveauaudio1a = document.createElement("source");
  bnouveauaudio1a.setAttribute("src", "data:audio/wav;bbase27wave2,");
...
cnouveauaudio1.setAttribute("id", "27cwav");
cnouveauaudio1.setAttribute("autobuffer", " ");
 cnouveauaudio1a = document.createElement("source");
  cnouveauaudio1a.setAttribute("src", "data:audio/wav;cbase27wave2,");
...
var audio = document.getElementById("27wav");
var source = document.createElement("source");
source.setAttribute("src", lenommeur);
audio.appendChild(source);

alenommeur = wave1.generate1();
var aaudio = document.getElementById("27awav");
...
var baudio = document.getElementById("27bwav");
...
var caudio = document.getElementById("27cwav");
