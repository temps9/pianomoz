...
nouveauaudio1.setAttribute("id", "32wav");
nouveauaudio1.setAttribute("autobuffer", " ");
 nouveauaudio1a = document.createElement("source");
  nouveauaudio1a.setAttribute("src", "data:audio/wav;base32wave2,");
...
anouveauaudio1.setAttribute("id", "32awav");
anouveauaudio1.setAttribute("autobuffer", " ");
 anouveauaudio1a = document.createElement("source");
  anouveauaudio1a.setAttribute("src", "data:audio/wav;abase32wave2,");
...
bnouveauaudio1.setAttribute("id", "32bwav");
bnouveauaudio1.setAttribute("autobuffer", " ");
 bnouveauaudio1a = document.createElement("source");
  bnouveauaudio1a.setAttribute("src", "data:audio/wav;bbase32wave2,");
...
cnouveauaudio1.setAttribute("id", "32cwav");
cnouveauaudio1.setAttribute("autobuffer", " ");
 cnouveauaudio1a = document.createElement("source");
  cnouveauaudio1a.setAttribute("src", "data:audio/wav;cbase32wave2,");
...
var audio = document.getElementById("32wav");
var source = document.createElement("source");
source.setAttribute("src", lenommeur);
audio.appendChild(source);

alenommeur = wave1.generate1();
var aaudio = document.getElementById("32awav");
...
var baudio = document.getElementById("32bwav");
...
var caudio = document.getElementById("32cwav");
