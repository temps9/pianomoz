...
nouveauaudio1.setAttribute("id", "33wav");
nouveauaudio1.setAttribute("autobuffer", " ");
 nouveauaudio1a = document.createElement("source");
  nouveauaudio1a.setAttribute("src", "data:audio/wav;base33wave2,");
...
anouveauaudio1.setAttribute("id", "33awav");
anouveauaudio1.setAttribute("autobuffer", " ");
 anouveauaudio1a = document.createElement("source");
  anouveauaudio1a.setAttribute("src", "data:audio/wav;abase33wave2,");
...
bnouveauaudio1.setAttribute("id", "33bwav");
bnouveauaudio1.setAttribute("autobuffer", " ");
 bnouveauaudio1a = document.createElement("source");
  bnouveauaudio1a.setAttribute("src", "data:audio/wav;bbase33wave2,");
...
cnouveauaudio1.setAttribute("id", "33cwav");
cnouveauaudio1.setAttribute("autobuffer", " ");
 cnouveauaudio1a = document.createElement("source");
  cnouveauaudio1a.setAttribute("src", "data:audio/wav;cbase33wave2,");
...
var audio = document.getElementById("33wav");
var source = document.createElement("source");
source.setAttribute("src", lenommeur);
audio.appendChild(source);

alenommeur = wave1.generate1();
var aaudio = document.getElementById("33awav");
...
var baudio = document.getElementById("33bwav");
...
var caudio = document.getElementById("33cwav");
